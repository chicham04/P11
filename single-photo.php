...
$photo_url = get_the_post_thumbnail_url(get_the_ID(), 'full'); // 'full' ou 'thumbnail' selon le format souhaité

if ($photo_url) :
?>
    <!-- Afficher l'image de la photo -->
    ...
    <div class="photo__gallery">
        <div class="photo__detail">
            <div class="photo__container">
                ...
                <img src="<?php echo esc_url($photoId); ?>">
